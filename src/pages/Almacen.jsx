...
import { Eye, Edit2, Trash2, Search, Home, Package, Users, DollarSign, Menu, Plus, X, AlertCircle, Truck, Warehouse } from 'lucide-react';
        ...
        <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f9fafb', fontFamily: 'system-ui' }}>
            ...
            <div style={{ width: sidebarOpen ? '256px' : '80px', backgroundColor: '#312e81', color: 'white', transition: 'width 0.3s', display: 'flex', flexDirection: 'column' }}>
                ...
                <nav style={{ flex: 1, padding: '16px' }}>
                    ...
                    <Link to="/proveedores" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '8px', marginBottom: '8px', textDecoration: 'none', color: 'white' }}>
                        <Truck size={20} />
                        {sidebarOpen && <span>Proveedores</span>}
                    </Link>

                    <Link to="/almacenes" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '8px', backgroundColor: '#4338ca', textDecoration: 'none', color: 'white', marginBottom: '8px' }}>
                        <Warehouse size={20} />
                                    ...
                                    <tbody>
                                        {filteredAlmacenes.length === 0 ? (
                                            ...
                                            filteredAlmacenes.map((almacen) => (
                                                <tr
                                                    key={almacen.id}
                                                    onClick={() => handleViewAlmacen(almacen)}
                                                ...
                                                >
                                                    ...
                                                    <td style={{ padding: '16px 24px' }}>
                                                        {getActivoBadge(almacen.activo)}
                                                    </td>
                                                    <td style={{ padding: '16px 24px' }} onClick={(e) => e.stopPropagation()}>
                                                        <div style={{ display: 'flex', gap: '8px' }}>
                                                            <button onClick={() => handleViewAlmacen(almacen)} style={{ padding: '8px', color: '#059669', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }} title="Ver"><Eye size={16} /></button>
                                                            <button onClick={() => handleEdit(almacen)} style={{ padding: '8px', color: '#4f46e5', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }} title="Editar"><Edit2 size={16} /></button>
                                                            <button onClick={() => handleDelete(almacen)} style={{ padding: '8px', color: '#dc2626', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }} title="Eliminar"><Trash2 size={16} /></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ))
