...
import { Eye, Edit2, Trash2, Search, Home, Package, Users, DollarSign, FileText, Menu, Plus, X, AlertCircle, BarChart2, Bell, User } from 'lucide-react';import { Link } from 'react-router-dom';
...
const MovimientoStockPage = () => {
  ...
  const getTitle = () => {
    switch (viewMode) {
      ...
      default: return 'Lista de Movimientos';
    }
  };
  ...
  const sidebarLinks = [
    ...
    { to: '/articulos', icon: <Package size={20} />, label: 'Artículos' },
    { to: '/almacenes', icon: <Package size={20} />, label: 'Almacenes' },
    { to: '/movimientos', icon: <FileText size={20} />, label: 'Movimientos', active: true },
      ...
      <div style={{ display: 'grid', gap: '24px' }}>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleInputChange('almacenId', e.target.value)}
            style={{ width: '100%', padding: '8px 12px', borderRadius: '8px', border: '1px solid #d1d5db', fontSize: '14px' }}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleInputChange('tipoMovimientoId', e.target.value)}
            style={{ width: '100%', padding: '8px 12px', borderRadius: '8px', border: '1px solid #d1d5db', fontSize: '14px' }}
          >
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100vw', position: 'fixed', top: 0, left: 0, backgroundColor: '#f9fafb', fontFamily: 'system-ui' }}>
      {/* SIDEBAR */}
      <div style={{ width: sidebarOpen ? '256px' : '80px', backgroundColor: '#312e81', color: 'white', transition: 'width 0.3s', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
        ...
        <nav style={{ flex: 1, padding: '16px', overflowY: 'auto' }}>
          {sidebarLinks.map(({ to, icon, label, active }) => (
            <Link
              key={to}
              to={to}
              style={{
                        ...
                        >
                          ...
                          <td style={{ padding: '16px 24px' }}>
                            <div style={{ display: 'flex', gap: '8px' }}>
                              <button onClick={() => handleViewMovimiento(mov)} style={{ padding: '8px', color: '#059669', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                                <Eye size={16} />
                              </button>
                              <button onClick={() => handleEdit(mov)} style={{ padding: '8px', color: '#4f46e5', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                                <Edit2 size={16} />
                              </button>
                              <button onClick={() => handleDelete(mov)} style={{ padding: '8px', color: '#dc2626', background: 'transparent', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
                                <Trash2 size={16} />
                              </button>
                            </div>
                          </td>
